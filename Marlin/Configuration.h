...
#define STRING_CONFIG_H_AUTHOR "(Herbstleyd, SapphirePlus)" // Who made the changes.
...
// Comment the following line to disable and enable bang-bang.
#define PIDTEMP
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -0.476 }
